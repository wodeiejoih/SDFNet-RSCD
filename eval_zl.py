...
def main():
    ...
    parser.add_argument('--project_name', default='lucannet6_SYSU', type=str)
    parser.add_argument('--print_models', default=False, type=bool, help='print models')
    parser.add_argument('--checkpoints_root', default='E:\data\STADE-CDNet\SYSU', type=str)
    parser.add_argument('--vis_root', default=r'E:\data\STADE-CDNet\vis', type=str)
